...
def home_team_won_last_nba(row):
    ...
    return result
"""
last_match_winner_nhl = defaultdict(int)

def home_team_won_last_nhl(row):
    home_team = row["Home Team"]
    visitor_team = row["Visitor Team"]
    
    #Sort for a consistent ordering
    teams = tuple(sorted([home_team, visitor_team]))
    result = 1 if last_match_winner_nhl[teams] == row["Home Team"] else 0
    #Update record for next encounter
    winner = row["Home Team"] if row["HomeWin"] else row["Visitor Team"]
    
    last_match_winner_nhl[teams] = winner
...
print("F1: {:.4f}".format(f1_score(y_true_nba_2021_2022, y_pred_nba_2021_2022_logistic_regression, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_nhl_2021_2022, y_pred_nhl_2021_2022_logistic_regression, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_mlb_2021, y_pred_mlb_2021_logistic_regression, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_nba_2021_2022, y_pred_nba_2021_2022_decision_tree, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_nhl_2021_2022, y_pred_nhl_2021_2022_decision_tree, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_mlb_2021, y_pred_mlb_2021_decision_tree, pos_label=None, average="weighted")))
...
print("")
print("Classification Report NBA (Nearest Neighbor):")
...
print("F1: {:.4f}".format(f1_score(y_true_nba_2021_2022, y_pred_nba_2021_2022_nearest_neighbor, pos_label=None, average="weighted")))
...
print("")
print("Classification Report NHL (Nearest Neighbor):")
...
print("F1: {:.4f}".format(f1_score(y_true_nhl_2021_2022, y_pred_nhl_2021_2022_nearest_neighbor, pos_label=None, average="weighted")))
...
print("")
print("Classification Report MLB (Nearest Neighbor):")
...
print("F1: {:.4f}".format(f1_score(y_true_mlb_2021, y_pred_mlb_2021_nearest_neighbor, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_nba_2021_2022, y_pred_nba_2021_2022_mlp, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_nhl_2021_2022, y_pred_nhl_2021_2022_mlp, pos_label=None, average="weighted")))
...
print("F1: {:.4f}".format(f1_score(y_true_mlb_2021, y_pred_mlb_2021_mlp, pos_label=None, average="weighted")))
